...
return [
    ...
    'checksum' => 'abd704af11afffa6318ab24a51151fee',
    'files' => [
        'user/config' => [
            'security' => [
        ...
        'user/plugins' => [
            ...
            'plugins/databasequeries' => [
                'file' => 'user/plugins/databasequeries/databasequeries.yaml',
                'modified' => 1739098791
            ],
            'plugins/problems' => [
            ...
            'plugins/database' => [
                'file' => 'user/plugins/database/database.yaml',
                'modified' => 1738749873
            ]
        ],
        'user/themes' => [
            'themes/quarkchild' => [
                'file' => 'user/themes/quarkchild/quarkchild.yaml',
                'modified' => 1699289922
            ],
            'themes/quark' => [
