...
return [
    ...
    'timestamp' => 1739606269,
    'checksum' => '089359809776c25f4f52bf0c71ce90ee',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/databasequeries' => [
                'file' => 'user/plugins/databasequeries/blueprints.yaml',
                'modified' => 1739093137
            ],
            'plugins/problems' => [
            ...
            'plugins/database' => [
                'file' => 'user/plugins/database/blueprints.yaml',
                'modified' => 1663076860
            ]
        ],
        'user/themes' => [
            'themes/quarkchild' => [
                'file' => 'user/themes/quarkchild/blueprints.yaml',
                'modified' => 1699289544
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.databasequeries.enabled' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ADMIN.ENABLED',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.databasequeries.enabled',
                'validation' => 'strict'
            ],
            'plugins.problems' => [
                'type' => '_root',
            ...
            'plugins.database.enabled' => [
                ...
                'name' => 'plugins.database.enabled',
                'validation' => 'strict'
            ],
            'plugins.database.connections' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.database.connections',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql' => [
                'type' => 'list',
                'name' => 'plugins.database.connections.mysql',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql.name' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.CONNECTION_NAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.mysql.name',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql.host' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.SERVER_HOST_IP',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.mysql.host',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql.port' => [
                'type' => 'text',
                ...
                'default' => 3306,
                'name' => 'plugins.database.connections.mysql.port',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql.dbname' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.DATABASE',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.mysql.dbname',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql.charset' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.MYSQL_CHARSET',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.mysql.charset',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql.username' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.USERNAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.mysql.username',
                'validation' => 'strict'
            ],
            'plugins.database.connections.mysql.password' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.PASSWORD',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.mysql.password',
                'validation' => 'strict'
            ],
            'plugins.database.mysql' => [
                ...
                'collapsed' => true,
                'collapsible' => true,
                'name' => 'plugins.database.mysql',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql' => [
                'type' => 'list',
                'name' => 'plugins.database.connections.pgsql',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql.name' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.CONNECTION_NAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.pgsql.name',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql.host' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.SERVER_HOST_IP',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.pgsql.host',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql.port' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.PORT',
                'validate' => [
                    'required' => true,
                ...
                'default' => 5432,
                'name' => 'plugins.database.connections.pgsql.port',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql.dbname' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.DATABASE',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.pgsql.dbname',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql.sslmode' => [
                'type' => 'select',
                ...
                'name' => 'plugins.database.connections.pgsql.sslmode',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql.user' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.USERNAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.pgsql.user',
                'validation' => 'strict'
            ],
            'plugins.database.connections.pgsql.password' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.PASSWORD',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.pgsql.password',
                'validation' => 'strict'
            ],
            'plugins.database.pgsql' => [
                'type' => 'fieldset',
                'collapsed' => true,
                'collapsible' => true,
                'name' => 'plugins.database.pgsql',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlite' => [
                'type' => 'list',
                'name' => 'plugins.database.connections.sqlite',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlite.name' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.CONNECTION_NAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlite.name',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlite.directory' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.SQLITE_DIRECTORY',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlite.directory',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlite.filename' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.SQLITE_FILENAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlite.filename',
                'validation' => 'strict'
            ],
            'plugins.database.sqlite' => [
                ...
                'collapsed' => true,
                'collapsible' => true,
                'name' => 'plugins.database.sqlite',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv' => [
                'type' => 'list',
                'name' => 'plugins.database.connections.sqlsrv',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv.name' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.CONNECTION_NAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlsrv.name',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv.server' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.SERVER_HOST_IP',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlsrv.server',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv.port' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.PORT',
                'validate' => [
                    'required' => true,
                ...
                'default' => 1433,
                'name' => 'plugins.database.connections.sqlsrv.port',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv.database' => [
                'type' => 'checkbox',
                'label' => 'PLUGIN_DATABASE.DATABASE',
                'name' => 'plugins.database.connections.sqlsrv.database',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv.encrypt' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.SQLSRV_ENCRYPT',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlsrv.encrypt',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv.username' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.USERNAME',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlsrv.username',
                'validation' => 'strict'
            ],
            'plugins.database.connections.sqlsrv.password' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.PASSWORD',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.database.connections.sqlsrv.password',
                'validation' => 'strict'
            ],
            'plugins.database.sqlsrv' => [
                'type' => 'fieldset',
                'collapsed' => true,
                'collapsible' => true,
                'name' => 'plugins.database.sqlsrv',
                'validation' => 'strict'
            ],
            'themes.quarkchild' => [
                'type' => '_root',
            ...
            'themes.quarkchild.production-mode' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.quarkchild.production-mode',
                'validation' => 'loose'
            ],
            'themes.quarkchild.grid-size' => [
                'type' => 'select',
                ...
                'name' => 'themes.quarkchild.grid-size',
                'validation' => 'loose'
            ],
            'themes.quarkchild.header_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quarkchild.header_section',
                'validation' => 'loose'
            ],
            'themes.quarkchild.custom_logo' => [
                'type' => 'file',
                'label' => 'Custom Logo',
                'size' => 'large',
                ...
                'name' => 'themes.quarkchild.custom_logo',
                'validation' => 'loose'
            ],
            'themes.quarkchild.custom_logo_mobile' => [
                'type' => 'file',
                ...
                'name' => 'themes.quarkchild.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.quarkchild.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quarkchild.header-fixed',
                'validation' => 'loose'
            ],
            'themes.quarkchild.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quarkchild.header-animated',
                'validation' => 'loose'
            ],
            'themes.quarkchild.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkchild.header-dark',
                'validation' => 'loose'
            ],
            'themes.quarkchild.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkchild.header-transparent',
                'validation' => 'loose'
            ],
            'themes.quarkchild.footer_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quarkchild.footer_section',
                'validation' => 'loose'
            ],
            'themes.quarkchild.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quarkchild.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.quarkchild.blog_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quarkchild.blog_section',
                'validation' => 'loose'
            ],
            'themes.quarkchild.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.quarkchild.blog-page',
                'validation' => 'loose'
            ],
            'themes.quarkchild.spectre_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quarkchild.spectre_section',
                'validation' => 'loose'
            ],
            'themes.quarkchild.spectre' => [
                'type' => '_parent',
                'name' => 'themes.quarkchild.spectre',
                'form_field' => false
            ],
            'themes.quarkchild.spectre.exp' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.quarkchild.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.quarkchild.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quarkchild.spectre.icons',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'databasequeries' => [
                    'enabled' => 'plugins.databasequeries.enabled'
                ],
                'problems' => [
                ...
                'database' => [
                    'enabled' => 'plugins.database.enabled',
                    'connections' => [
                        'mysql' => [
                            'name' => 'plugins.database.connections.mysql.name',
                            'host' => 'plugins.database.connections.mysql.host',
                            'port' => 'plugins.database.connections.mysql.port',
                            'dbname' => 'plugins.database.connections.mysql.dbname',
                            'charset' => 'plugins.database.connections.mysql.charset',
                            'username' => 'plugins.database.connections.mysql.username',
                            'password' => 'plugins.database.connections.mysql.password'
                        ],
                        'pgsql' => [
                            'name' => 'plugins.database.connections.pgsql.name',
                            'host' => 'plugins.database.connections.pgsql.host',
                            'port' => 'plugins.database.connections.pgsql.port',
                            'dbname' => 'plugins.database.connections.pgsql.dbname',
                            'sslmode' => 'plugins.database.connections.pgsql.sslmode',
                            'user' => 'plugins.database.connections.pgsql.user',
                            'password' => 'plugins.database.connections.pgsql.password'
                        ],
                        'sqlite' => [
                            'name' => 'plugins.database.connections.sqlite.name',
                            'directory' => 'plugins.database.connections.sqlite.directory',
                            'filename' => 'plugins.database.connections.sqlite.filename'
                        ],
                        'sqlsrv' => [
                            'name' => 'plugins.database.connections.sqlsrv.name',
                            'server' => 'plugins.database.connections.sqlsrv.server',
                            'port' => 'plugins.database.connections.sqlsrv.port',
                            'database' => 'plugins.database.connections.sqlsrv.database',
                            'encrypt' => 'plugins.database.connections.sqlsrv.encrypt',
                            'username' => 'plugins.database.connections.sqlsrv.username',
                            'password' => 'plugins.database.connections.sqlsrv.password'
                        ]
                    ],
                    'mysql' => 'plugins.database.mysql',
                    'pgsql' => 'plugins.database.pgsql',
                    'sqlite' => 'plugins.database.sqlite',
                    'sqlsrv' => 'plugins.database.sqlsrv'
                ]
            ],
            'themes' => [
                'quarkchild' => [
                    'production-mode' => 'themes.quarkchild.production-mode',
                    'grid-size' => 'themes.quarkchild.grid-size',
                    'header_section' => 'themes.quarkchild.header_section',
                    'custom_logo' => 'themes.quarkchild.custom_logo',
                    'custom_logo_mobile' => 'themes.quarkchild.custom_logo_mobile',
                    'header-fixed' => 'themes.quarkchild.header-fixed',
                    'header-animated' => 'themes.quarkchild.header-animated',
                    'header-dark' => 'themes.quarkchild.header-dark',
                    'header-transparent' => 'themes.quarkchild.header-transparent',
                    'footer_section' => 'themes.quarkchild.footer_section',
                    'sticky-footer' => 'themes.quarkchild.sticky-footer',
                    'blog_section' => 'themes.quarkchild.blog_section',
                    'blog-page' => 'themes.quarkchild.blog-page',
                    'spectre_section' => 'themes.quarkchild.spectre_section',
                    'spectre' => [
                        'exp' => 'themes.quarkchild.spectre.exp',
                        'icons' => 'themes.quarkchild.spectre.icons'
                    ]
                ],
                'quark' => [
