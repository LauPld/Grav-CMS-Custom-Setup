...
return [
    ...
    'checksum' => '5cf0510a1710a12d5fe82f8789cd414d',
    'files' => [
        'system/languages' => [
            'ar' => [
        ...
        'user/plugins' => [
            ...
            'plugins/database' => [
                'file' => 'user/plugins/database/languages.yaml',
                'modified' => 1663076860
            ]
        ]
    ],
    'data' => [
        'en' => [
            ...
            'PLUGIN_DATABASE' => [
                ...
                'DRIVER_SQLSRV' => 'Microsoft SQL Server',
                'MYSQL_CHARSET' => 'Charset',
                'PASSWORD' => 'Password',
                'PGSQL_SSLMODE' => 'SSL Mode',
                'PORT' => 'Port',
                'SERVER_HOST_IP' => 'Server / Host / IP',
                'SQLITE_DIRECTORY' => 'Directory',
                'SQLITE_FILENAME' => 'File Name',
                'SQLSRV_ENCRYPT' => 'Encrypt',
                'USERNAME' => 'Username'
            ],
            'GRAV' => [
